...
const VM_ABI = [
    ...
    "function register_operator_to_tos(bytes16 tos_id, tuple(bytes20 id, address operator, tuple(string app_id, tuple(string rootfs_hash, string mrtd, string rtmr0, string rtmr1, string rtmr2, string rtmr3) tcb, bytes certificate) vm_report, uint8 status) vm)",
    ...
    "function get_vm_by_index(uint256 index) public view returns (tuple(bytes20 id, address operator, tuple(string app_id, tuple(string rootfs_hash, string mrtd, string rtmr0, string rtmr1, string rtmr2, string rtmr3) tcb, bytes certificate) vm_report, uint8 status))"
];
